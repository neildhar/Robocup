...
#define BA_Kp 0.71
#define CA_Kp 1.42
#define BT_aimKp 0.4615 //90/195

#define kAOG 240

#define trueMagVal 110

//Declare Compound Eyes
JM::compoundEye back_CE(&Wire1);
JM::compoundEye front_CE(&Wire);

//Declare SRF10 Ultrasonic Rangefinder
...
int BT_ballPos, BT_ballDist, BT_dirMod, BT_clockPort, BT_anticlockPort, BT_bulb;
...
//Declare Table of Precomputed Motor Values
...
void loop() {
    ...
    if(compassValue<=2||compassValue>=358){
      ...
      NEPower=SEPower=(CA_correction)+4;
      NWPower=SWPower=(CA_correction*(-1))-4;
      negNESE=-NEPower;
      negNWSW=-NWPower;  
      VD_compound++;    
    }
        ...
        NEPower=SEPower=((CA_correction)*(-1)-4);
        NWPower=SWPower=(CA_correction)+4;
        negNESE=-NEPower;
        negNWSW=-NWPower;
        VD_compound++;
      }
